        ...
        function(a, b, c) {
          ...
          b.exports = function(b, c) {
            ...
            function i(a, b, e, g, h) {
              function i(c) {
                ...
                if (
                  ...
                  (i.rootpath = j.rootpath || i.currentDirectory),
                  h)
                ) {
                  h.remaining = g;
                ...
                q.remove(f),
                  ...
                  m.render(d, j, function(c, e) {
                    c
                      ? ((c.href = f), b(c))
                      : (r.setCSS(a.href, h.lastModified, j.modifyVars, e.css),
            ...
            a('./image-size')(m.environment),
              c.functions && m.functions.functionRegistry.addMultiple(c.functions);
            var s = /^text\/(x-)?less$/;
            return (
              (m.watch = function() {
              ...
              (m.registerStylesheetsImmediately = function() {
                ...
                for (var b = 0; b < a.length; b++)
                  ('stylesheet/less' === a[b].rel ||
                    (a[b].rel.match(/stylesheet/) && a[b].type.match(s))) &&
                    m.sheets.push(a[b]);
              }),
                            ...
                            function(a, c, h, j, n) {
                              return a
                                ...
                                : (m.logger.info(
                                  ...
                                  m.logger.info(
                                    'CSS for ' + j.href + ' generated in ' + (new Date() - i) + 'ms'
                                  ),
                                  l--,
                                  0 === l &&
                                    ((k = new Date() - g),
                                    m.logger.info(
                                      'Less has finished. CSS generated in ' + k + 'ms'
                                    ),
                                    d({
                                      startTime: g,
                                      endTime: i,
      ...
      19: [
        function(a, b, c) {
          ...
          (f.prototype.evalPlugin = function(a, b, c, f, g) {
            ...
            if ((j || (j = k.exports), (j = this.validatePlugin(j, m, o)), j instanceof e))
              return j;
            if (!j) return new e({ message: 'Not a valid plugin' }, c, m);
            if (
              ((j.imports = c),
              (j.filename = m),
              (!j.minVersion || this.compareVersion('3.0.0', j.minVersion) < 0) &&
              ...
              return a
                ? ('function' == typeof a && (a = new a()),
                  a.minVersion && this.compareVersion(a.minVersion, this.less.version) < 0
                    ? new e({
                        message:
                          'Plugin ' + c + ' requires version ' + this.versionToString(a.minVersion),
                      })
                    : a)
                : null;
            }),
        ...
        function(a, b, c) {
          ...
          (h = {
            ...
            color: function(a) {
              if (
                a instanceof k &&
                /^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})$/i.test(a.value)
              ) {
        ...
        function(a, b, c) {
          b.exports = function(b) {
            ...
            f.add('data-uri', function(a, f) {
              ...
              if (!s.contents)
                return (
                  h.warn('Skipped data-uri embedding of ' + j + ' because file not found'),
                  g(this, f || a)
                );
              var t = s.contents;
            ...
            each: function(a, b) {
              ...
              for (var o = 0; o < g.length; o++) {
                var p,
                  ...
                  r = g[o];
                r instanceof f
                  ? ((p = 'string' == typeof r.name ? r.name : r.name[0].value), (q = r.value))
                  : ((p = new e(o + 1)), (q = r)),
                  r instanceof d ||
                    ((c = b.rules.slice(0)),
                    l && c.push(new f(l, q, !1, !1, this.index, this.currentFileInfo)),
                    n && c.push(new f(n, new e(o + 1), !1, !1, this.index, this.currentFileInfo)),
                    m && c.push(new f(m, p, !1, !1, this.index, this.currentFileInfo)),
                    k.push(
                      new h([new i([new j('', '&')])], c, b.strictImports, b.visibilityInfo())
                    ));
              }
              return new h([new i([new j('', '&')])], k, b.strictImports, b.visibilityInfo()).eval(
                this.context
              );
            },
          });
                  ...
                  r = function(a) {
                    ...
                    (o.currentDirectory = p.getPath(c)),
                      o.rewriteUrls &&
                        ((o.rootpath = p.join(
                          l.context.rootpath || '',
                          p.pathDiff(o.currentDirectory, o.entryPath)
                        )),
                    ...
                    (h.processImports = !1),
                      ...
                      j.isPlugin
                        ? ((b = m.evalPlugin(g, h, l, j.pluginArgs, o)),
                          b instanceof f ? n(b, null, c) : n(null, b, c))
                        : j.inline
                        ? n(null, g, c)
          ...
          (e.prototype.constructor = e),
            (e.prototype.toString = function(a) {
              ...
              if (a.stylize) {
                ...
                if ('function' !== f)
                  throw Error('options.stylize should be a function, got a ' + f + '!');
                e = a.stylize;
              }
              if (null !== this.line) {
                if (
                  ('string' == typeof c[0] && d.push(e(this.line - 1 + ' ' + c[0], 'grey')),
                  'string' == typeof c[1])
                ) {
                  var g = this.line + ' ';
                  c[1] &&
                    (g +=
                      ...
                      e(
                        e(
                          e(c[1].substr(this.column, 1), 'bold') + c[1].slice(this.column + 1),
                          'red'
                        ),
                        'inverse'
                      )),
              ...
              return (
                ...
                this.line &&
                  (b += e(' on line ' + this.line + ', column ' + (this.column + 1) + ':', 'grey')),
                (b += '\n' + d),
                this.callLine &&
              ...
              (k.$parseUntil = function(c) {
                ...
                d =
                  'string' == typeof c
                    ...
                    : function(a) {
                        return c.test移动端图片适配(a);
                      };
                do {
                  var q,
                    r = b.charAt(o);
                  if (0 === h && d(r))
                    (f = b.substr(n, o - n)), j.push(f ? f : ' '), (f = j), a(o - m), (p = !1);
                  else {
                    if (g) {
        ...
        function(a, b, c) {
          var d = a('../less-error'),
            ...
            j = function k(a, b, c) {
              function j(a, e) {
                throw new d(
                  { index: q.i, filename: c.filename, type: e || 'Syntax', message: a },
                  b
                );
              }
              function l(a, b) {
              ...
              function m(a, b) {
                return q.$char(a)
                  ? a
                  : void j(b || "expected '" + a + "' got '" + q.currentChar() + "'");
              }
              function n(a) {
                var b = c.filename;
              ...
              function o(a, c, e, f, g) {
                ...
                try {
                  ...
                  for (var k, l, m = 0; (k = c[m]); m++)
                    (l = j.i),
                      (h = p[k]()),
                      h ? ((h._index = l + e), (h._fileInfo = f), i.push(h)) : i.push(null);
                  var n = j.end();
                ...
                parse: function(g, h, j) {
                  ...
                  if (!v.isFinished) {
                    ...
                    w ||
                      ...
                      (p = new d(
                        { type: 'Parse', message: w, index: v.furthest, filename: c.filename },
                        b
                      ));
                  }
                  var x = function(a) {
                    return (
                      (a = p || a || b.error),
                      a ? (a instanceof d || (a = new d(a, b, c.filename)), h(a)) : h(null, l)
                    );
                  };
                ...
                parsers: (p = {
                  ...
                  entities: {
                    ...
                    quoted: function(a) {
                      ...
                      return (b = q.$quoted())
                        ? (q.forget(),
                          new e.Quoted(b.charAt(0), b.substr(1, b.length - 2), f, d, c))
                        : void q.restore();
                    },
                    keyword: function() {
                      var a =
                        q.$char('%') ||
                        q.$re(/^\[?(?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+\]?/);
                    ...
                    arguments: function(a) {
                      ...
                      for (q.save(); ; ) {
                        if (a) a = !1;
                          ...
                          if (
                            ((c = p.detachedRuleset() || this.assignment() || p.expression()), !c)
                          )
                            break;
                        ...
                        q.$char(',') ||
                          ((q.$char(';') || b) &&
                            ((b = !0),
                            (c = d.length < 1 ? d[0] : new e.Value(d)),
                            f.push(c),
                            (d = [])));
                      }
                    ...
                    color: function() {
                      ...
                      if (
                        '#' === q.currentChar() &&
                        (a = q.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})/))
                      )
                    ...
                    unicodeDescriptor: function() {
                      var a;
                      if ((a = q.$re(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/)))
                  ...
                  variableCall: function(a) {
                    ...
                    if (
                      ...
                      return !g && p.end()
                        ? (q.forget(), i)
                        : (q.forget(), new e.NamespaceValue(i, b, d, f, c));
                    }
                    q.restore();
                  },
                  extend: function(a) {
                      ...
                      for (q.save(); ; ) {
                        ...
                        if (
                          ...
                          if (q.$char(':')) {
                            if (
                              (m.length > 0 &&
                                (b && j('Cannot mix ; and , as delimiter types'), (c = !0)),
                  ...
                  ieAlpha: function() {
                    ...
                    if (q.$re(/^opacity=/i))
                      return (
                        (a = q.$re(/^\d+/)),
                        a ||
                          ((a = l(p.entities.variable, 'Could not parse alpha')),
                          (a = '@{' + a.name.slice(1) + '}')),
                        m(')'),
                  ...
                  selectors: function() {
                    for (var a, b; ; ) {
                      ...
                      if (
                        ...
                        a.condition &&
                          b.length > 1 &&
                          j('Guards are only currently allowed on a single selector.'),
                        !q.$char(','))
                      )
                        break;
                  ...
                  detachedRuleset: function() {
                    ...
                    if (
                      (q.save(),
                      q.$re(/^[.#]\(/) &&
                        ((a = this.mixin.args(!1)), (b = a.args), (c = a.variadic), !q.$char(')')))
                    )
                      return void q.restore();
                    var d = this.blockRuleset();
                    return d
                      ? (q.forget(),
                        b ? new e.mixin.Definition(null, b, d, null, c) : new e.DetachedRuleset(d))
                      : void q.restore();
                  },
                  ruleset: function() {
                    var b, c, d;
                    ...
                    if ('.' !== j && '#' !== j && '&' !== j && ':' !== j)
                      if ((q.save(), (a = this.variable() || this.ruleProperty()))) {
                        if (
                          ...
                          b || (b = this.value()),
                            b ? (f = this.important()) : h && (b = this.permissiveValue());
                        }
                        if (b && (this.end() || d))
                          return q.forget(), new e.Declaration(a, b, f, g, i, c);
                        q.restore();
                      } else q.restore();
                  },
                  ...
                  permissiveValue: function(a) {
                    function b() {
                      var a = q.currentChar();
                      return 'string' == typeof i ? a === i : i.test移动端图片适配(a);
                    }
                    var d,
                      f,
                      g,
                    ...
                    if (!b()) {
                      h = [];
                      do
                        (f = this.comment()), f ? h.push(f) : ((f = this.entity()), f && h.push(f));
                      while (f);
                      if (((g = b()), h.length > 0)) {
                      ...
                      if ((q.save(), (h = q.$parseUntil(i)))) {
                        if (
                          ('string' == typeof h && j("Expected '" + h + "'", 'Parse'),
                          1 === h.length && ' ' === h[0])
                        )
                          return q.forget(), new e.Anonymous('', k);
                        var m;
                        for (d = 0; d < h.length; d++)
                          if (((m = h[d]), Array.isArray(m)))
                            l.push(new e.Quoted(m[0], m[1], !0, k, c));
                          else {
                    ...
                    if (f) {
                      ...
                      if ((a = this.entities.quoted() || this.entities.url()))
                        return (
                          ...
                          q.$char(';') ||
                            ((q.i = d),
                            j('missing semi-colon or unrecognised media features on import')),
                          (b = b && new e.Value(b)),
                        ...
                        a
                          ...
                          : q.$char('(') &&
                            ...
                            q.$char(')')
                              ? b && a
                                ? f.push(
                                    new e.Paren(new e.Declaration(b, a, null, null, q.i, c, !0))
                                  )
                                : a
                  ...
                  mediaFeatures: function() {
                    ...
                    do
                      if ((a = this.mediaFeature())) {
                        ...
                        ((a = b.variable() || b.mixinLookup()), a && (c.push(a), !q.$char(',')))
                      )
                        break;
                    while (a);
                          ...
                          h
                            ...
                            : k &&
                              ...
                              d
                                ...
                                : m ||
                                  ';' === q.currentChar() ||
                                  j(b + ' rule is missing block or ending semi-colon')),
                          m && (f = this.blockRuleset()),
                          f || (!m && d && q.$char(';'))
                            ? (q.forget(),
                              new e.AtRule(b, d, f, l, c, a.dumpLineNumbers ? n(l) : null, o))
                  ...
                  parenthesisCondition: function(a) {
                    function b(b) {
                      ...
                      return (
                        q.save(),
                        (c = b.condition(a)) && q.$char(')') ? (q.forget(), c) : void q.restore()
                      );
                    }
                    var c;
                    return (
                  ...
                  atomicCondition: function(a) {
                    ...
                    if (((b = b.bind(this)), (c = b())))
                      return (
                        ...
                        g
                          ? ((d = b()),
                            d ? (f = new e.Condition(g, c, d, i, !1)) : j('expected expression'))
                        ...
                        a
                          ...
                          : ((a = this.addition() || this.entity()),
                            a &&
                              (c.push(a),
                              q.peek(/^\/[\/*]/) ||
                                ((b = q.$char('/')), b && c.push(new e.Anonymous(b, d)))));
                    while (a);
                  ...
                  ruleProperty: function() {
                    ...
                    if (f.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                      for (
                        q.forget(), '' === f[0] && (f.shift(), g.shift()), d = 0;
                        d < f.length;
                        d++
                      )
                        (b = f[d]),
              ...
              for (var m = 0; m < 2; m++)
                for (j.first(); (i = j.get()); )
                  i.isPreEvalVisitor
                    ...
                    : (0 !== m && k.indexOf(i) !== -1) ||
                      (i.isPreVisitor ? k.unshift(i) : k.push(i));
            }
            c = a.eval(h);
            for (var m = 0; m < k.length; m++) k[m].run(c);
            if (b.pluginManager)
              for (j.first(); (i = j.get()); )
                k.indexOf(i) === -1 && l.indexOf(i) === -1 && i.run(c);
            return c;
          };
        },
        ...
        function(a, b, c) {
          ...
          (h.prototype = new f()),
            ...
            (h.prototype.operate = function(a, b, c) {
              for (
                var d = new Array(3), e = this.alpha * (1 - c.alpha) + c.alpha, f = 0;
                f < 3;
                f++
              )
        ...
        function(a, b, c) {
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.genCSS = function(a, b) {
              this.debugInfo && b.add(e(a, this), this.fileInfo(), this.getIndex()),
                b.add(this.value);
            }),
          ...
          (j.prototype = new e()),
            ...
            (j.prototype.eval = function(a) {
              var b,
                ...
                h = this.variable;
              'string' != typeof f &&
                ((f = 1 === f.length && f[0] instanceof g ? f[0].value : d(a, f)), (h = !1)),
                'font' === f &&
                  a.math === i.ALWAYS &&
                  ((e = !0), (b = a.math), (a.math = i.PARENS_DIVISION));
              try {
                if (
                  (a.importantScope.push({}),
                  (c = this.value.eval(a)),
                  !this.variable && 'DetachedRuleset' === c.type)
                )
                  throw {
      ...
      62: [
        function(a, b, c) {
          var d = a('./node'),
            ...
            g = a('./color'),
            h = function(a, b) {
              if (((this.value = parseFloat(a)), isNaN(this.value)))
            ...
            (i.prototype.genCSS = function(a, b) {
              for (var c = 0; c < this.value.length; c++)
                this.value[c].genCSS(a, b),
                  !this.noSpacing && c + 1 < this.value.length && b.add(' ');
            }),
        ...
        function(a, b, c) {
          ...
          (k.prototype = new i()),
            ...
            (k.prototype.bubbleSelectors = function(a) {
              a &&
                ((this.rules = [new d(j.copyArray(a), [this.rules[0]])]),
                this.setParent(this.rules, this));
            }),
            (b.exports = k);
        },
                ...
                for (c = k.copyArray(c), u = c.length, m = 0; m < u; m++)
                  if (((l = c[m]), (p = l && l.name))) {
                    for (q = !1, n = 0; n < t.length; n++)
                      if (!d[n] && p === t[n].name) {
                        (d[n] = l.value.eval(a)),
                          s.prependRule(new g(p, l.value.eval(a))),
                          (q = !0);
                        break;
                      }
                    if (q) {
                ...
                if (!d[m]) {
                  if (((l = c && c[r]), (p = t[m].name)))
                    if (t[m].variadic) {
                      ...
                      if ((o = l && l.value))
                        o = Array.isArray(o) ? new h(new f('', o)) : o.eval(a);
                      else {
                        if (!t[m].value)
                          throw {
                            type: 'Runtime',
                ...
                !this.condition.eval(
                  new j.Eval(
                    ...
                    [
                      this.evalParams(
                        b,
                        new j.Eval(b, this.frames ? this.frames.concat(b.frames) : b.frames),
                        a,
                        []
                      ),
                    ]
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function(a) {
              ...
              for (b = 0; b < this.lookups.length; b++) {
                if (
                  ((c = this.lookups[b]), Array.isArray(d) && (d = new f([new g()], d)), '' === c)
                )
                  d = d.lastDeclaration();
                else if ('@' === c.charAt(0)) {
                  if (
        ...
        function(a, b, c) {
          ...
          (q.prototype = new d()),
              ...
              for (g = 0; (l = v[g]); g++)
                if (
                  ...
                  for (var j = 0; (o = l.rules[j]); j++)
                    o instanceof d &&
                      (o.copyVisibilityInfo(l.visibilityInfo()),
                      (o instanceof e && o.variable) || v.splice(++g, 0, o));
                }
            ...
            (q.prototype.matchCondition = function(a, b) {
              ...
              return (
                !!c.evaldCondition && !(c.condition && !c.condition.eval(new l.Eval(b, b.frames)))
              );
            }),
                  ...
                  (this._properties = this.rules
                    ? this.rules.reduce(function(a, b) {
                        if (b instanceof e && b.variable !== !0) {
                          var c =
                            1 === b.name.length && b.name[0] instanceof f
                              ? b.name[0].value
                              : b.name;
                ...
                return a.value instanceof k && !a.parsed
                  ? ('string' == typeof a.value.value
                      ? this.parse.parseNode(
                          ...
                          function(b, c) {
                            b && (a.parsed = !0),
                              c && ((a.value = c[0]), (a.important = c[1] || ''), (a.parsed = !0));
                          }
                        )
                      : (a.parsed = !0),
                    a)
              ...
              function d(a, b) {
                ...
                if (0 === a.length) c = new h(a[0]);
                  ...
                  for (d = 0; d < a.length; d++)
                    e[d] = new j(null, a[d], b.isVariable, b._index, b._fileInfo);
                  c = new h(new i(e));
                }
                return c;
              }
              ...
              function f(a, b, c, d) {
                ...
                if (
                  ...
                  a.length > 0
                    ? ((e = p.copyArray(a)),
                      (f = e.pop()),
                      (g = d.createDerived(p.copyArray(f.elements))))
                    : (g = d.createDerived([])),
                  b.length > 0)
                ) {
                  var h = c.combinator,
              ...
              function l(a, b, c) {
                function m(a) {
                  ...
                  return a.value instanceof h
                    ? ((b = a.value.value), b instanceof i ? b : null)
                    : null;
                }
                var n,
                  o,
                  ...
                  if ('&' !== u.value) {
                    ...
                    for (x = !0, s = [], k(q, r), o = 0; o < r.length; o++)
                      if (((t = r[o]), 0 === b.length))
                        t.length > 0 &&
                          t[0].elements.push(
                            new j(u.combinator, '', u.isVariable, u._index, u._fileInfo)
                          ),
                          s.push(t);
                      else
                ...
                for (k(q, r), n = 0; n < r.length; n++)
                  (v = r[n].length),
                    v > 0 &&
                      (a.push(r[n]),
                      (w = r[n][v - 1]),
                      (r[n][v - 1] = w.createDerived(w.elements, c.extendList)));
                return x;
              }
              function m(a, b) {
        ...
        function(a, b, c) {
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.createDerived = function(a, b, c) {
              ...
              return (
                (d.evaldCondition = null != c ? c : this.evaldCondition),
            ...
            (g.prototype.getElements = function(a) {
              return a
                ? ('string' == typeof a &&
                    this.parse.parseNode(a, ['selector'], this._index, this._fileInfo, function(
                      b,
                      c
                    ) {
                      if (b)
        ...
        function(a, b, c) {
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.eval = function(a) {
              ...
              if (
                (0 === c.indexOf('@@') &&
                  (c = '@' + new f(c.slice(1), this.getIndex(), this.fileInfo()).eval(a).value),
                this.evaluating)
              )
                throw {
                  type: 'Name',
        ...
        function(a, b, c) {
          ...
          (h.prototype = {
            ...
            onImported: function(a, b, c, d, e, f) {
              c &&
                (c.filename || ((c.index = a.getIndex()), (c.filename = a.fileInfo().filename)),
                (this.error = c));
              var g = this,
                h = a.options.inline,
        ...
        function(a, b, c) {
          ...
          (g.prototype = {
            ...
            visitMedia: function(a, b) {
              ...
              return (
                a.accept(this._visitor), (b.visitDeeper = !1), this.cncUtils.resolveVisibility(a, c)
              );
            },
            visitImport: function(a, b) {
            ...
            visitAtRuleWithBody: function(a, b) {
              ...
              return (
                ...
                (b.visitDeeper = !1),
                this.cncUtils.isEmpty(a) || this._mergeRules(a.rules[0].rules),
                this.cncUtils.resolveVisibility(a, e)
              );
            },
            ...
            visitRuleset: function(a, b) {
              ...
              return (
                ...
                this.cncUtils.isVisibleRuleset(a) && (a.ensureVisibility(), d.splice(0, 0, a)),
                1 === d.length ? d[0] : d
              );
            },
      ...
      100: [
        function(a, b, c) {
          var d = (function() {
            ...
            function b(c, d, e, f, i) {
              function l(c, e) {
                ...
                if (a(c, h)) p = new h();
                  ...
                  (p = new RegExp(c.source, g(c))), c.lastIndex && (p.lastIndex = c.lastIndex);
                  ...
                  a(c, Error)
                    ? (p = Object.create(c))
                    : 'undefined' == typeof f
                    ? ((q = Object.getPrototypeOf(c)), (p = Object.create(q)))
                ...
                for (var s in c) {
                  var t;
                  q && (t = Object.getOwnPropertyDescriptor(q, s)),
                    (t && null == t.set) || (p[s] = l(c[s], e - 1));
                }
                if (Object.getOwnPropertySymbols)
                  for (var u = Object.getOwnPropertySymbols(c), s = 0; s < u.length; s++) {
                    ...
                    (!w || w.enumerable || i) &&
                      ((p[v] = l(c[v], e - 1)),
                      w.enumerable || Object.defineProperty(p, v, { enumerable: !1 }));
                  }
                if (i)
                  for (var x = Object.getOwnPropertyNames(c), s = 0; s < x.length; s++) {
                    ...
                    (w && w.enumerable) ||
                      ((p[y] = l(c[y], e - 1)), Object.defineProperty(p, y, { enumerable: !1 }));
                  }
                return p;
              }
              'object' == typeof d &&
                ((e = d.depth), (f = d.prototype), (i = d.includeNonEnumerable), (d = d.circular));
              var m = [],
                n = [],
                o = 'undefined' != typeof Buffer;
              return (
                'undefined' == typeof d && (d = !0), 'undefined' == typeof e && (e = 1 / 0), l(c, e)
              );
            }
            function c(a) {
            ...
            function e(a) {
              return 'object' == typeof a && '[object Array]' === c(a);
            }
            function f(a) {
            ...
            function g(a) {
              var b = '';
              return (
                a.global && (b += 'g'), a.ignoreCase && (b += 'i'), a.multiline && (b += 'm'), b
              );
            }
            var h;
            try {
